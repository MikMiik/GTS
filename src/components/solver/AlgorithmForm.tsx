...
export default function AlgorithmForm({
  ...
  useEffect(() => {
    ...
    const merged = { ...defaultValues, ...storedValues };
  ...
  }, [method, defaultValues, storedValues]);
  ...
  return (
    <form id="solver-form" ref={formRef} onSubmit={handleSubmit}>
      <FormFields method={method} onChange={handleChange} onKeyDown={handleKeyDown} />
    </form>
  );
}
...
function FormFields({ method, onChange, onKeyDown }: FieldProps & { method: AlgorithmKey }) {
  switch (method) {
    case "bisection": return <BisectionFields onChange={onChange} onKeyDown={onKeyDown} />;
    case "tieptuyen": return <TiepTuyenFields onChange={onChange} onKeyDown={onKeyDown} />;
    case "daycung":   return <DayCungFields onChange={onChange} onKeyDown={onKeyDown} />;
    case "lapdon":    return <LapDonFields onChange={onChange} onKeyDown={onKeyDown} />;
    case "gauss":     return <MatrixFields onChange={onChange} />;
...
function BisectionFields({ onChange, onKeyDown }: FieldProps) {
  return (
    <>
      ...
      <div className="form-group">
        ...
        <input className="form-input" id="in-f" name="fStr" type="text" spellCheck={false} autoComplete="off" onChange={onChange} onKeyDown={onKeyDown} />
      ...
      <div className="form-row">
        <div className="form-group">
          ...
          <input className="form-input" id="in-a" name="a" type="number" step="any" onChange={onChange} onKeyDown={onKeyDown} />
        </div>
        <div className="form-group">
          <label className="form-label" htmlFor="in-b">Cận trên <code>b</code></label>
          <input className="form-input" id="in-b" name="b" type="number" step="any" onChange={onChange} onKeyDown={onKeyDown} />
        </div>
      </div>
      <div className="form-section-title">Tham số</div>
      <div className="form-group">
        <label className="form-label" htmlFor="in-eps">Sai số <code>ε (epsilon)</code></label>
        <input className="form-input" id="in-eps" name="epsilon" type="text" spellCheck={false} onChange={onChange} onKeyDown={onKeyDown} />
...
function TiepTuyenFields({ onChange, onKeyDown }: FieldProps) {
  return (
    <>
      ...
      <div className="form-group">
        ...
        <input className="form-input" id="in-df" name="dfStr" type="text" spellCheck={false} autoComplete="off" onChange={onChange} onKeyDown={onKeyDown} />
      </div>
      <div className="form-group">
        <label className="form-label" htmlFor="in-ddf">Đạo hàm bậc 2 <code>f&apos;&apos;(x)</code></label>
        <input className="form-input" id="in-ddf" name="ddfStr" type="text" spellCheck={false} autoComplete="off" onChange={onChange} onKeyDown={onKeyDown} />
      </div>
      ...
      <div className="form-row">
        <div className="form-group">
          ...
          <input className="form-input" id="in-m1" name="m1" type="number" step="any" onChange={onChange} onKeyDown={onKeyDown} />
        </div>
        <div className="form-group">
...
function DayCungFields({ onChange, onKeyDown }: FieldProps) {
  return (
    <>
      <div className="form-section-title">Hàm số</div>
      <div className="form-group">
...
function LapDonFields({ onChange, onKeyDown }: FieldProps) {
  return (
    <>
      ...
      <div className="form-group">
        ...
        <input className="form-input" id="in-phi" name="phiStr" type="text" spellCheck={false} autoComplete="off" onChange={onChange} onKeyDown={onKeyDown} />
      ...
      <div className="form-group">
        ...
        <input className="form-input" id="in-x0" name="x0" type="number" step="any" onChange={onChange} onKeyDown={onKeyDown} />
      </div>
      <div className="form-row">
        <div className="form-group">
          <label className="form-label" htmlFor="in-q">Hệ số co <code>q</code> (0 &lt; q &lt; 1)</label>
          <input className="form-input" id="in-q" name="q" type="number" step="any" min="0" max="1" onChange={onChange} onKeyDown={onKeyDown} />
        </div>
        <div className="form-group">
          <label className="form-label" htmlFor="in-eps">Sai số <code>ε</code></label>
          <input className="form-input" id="in-eps" name="epsilon" type="text" onChange={onChange} onKeyDown={onKeyDown} />
...
function MatrixFields({ onChange }: { onChange: React.ChangeEventHandler<HTMLTextAreaElement> }) {
  return (
    <>
      ...
      <div className="form-group">
        ...
        <textarea className="form-textarea" id="in-matA" name="matA" rows={4} spellCheck={false} onChange={onChange} />
      </div>
      ...
      <div className="form-group">
        ...
        <textarea className="form-textarea" id="in-matB" name="matB" rows={4} spellCheck={false} onChange={onChange} />
...
function GaussJordanFields({ onChange }: { onChange: React.ChangeEventHandler<HTMLTextAreaElement> }) {
  return (
    <>
      <div className="matrix-help">
        📋 Nhập mỗi hàng trên một dòng, các giá trị cách nhau bằng khoảng trắng hoặc dấu phẩy.<br />
      ...
      <div className="form-group">
        <label className="form-label" htmlFor="in-matA">Ma trận A</label>
        <textarea className="form-textarea" id="in-matA" name="matA" rows={5} spellCheck={false} onChange={onChange} />
      </div>
      <div className="form-section-title">Ma trận B (vế phải)</div>
      <div className="form-group">
        <label className="form-label" htmlFor="in-matB">Ma trận B</label>
        <textarea className="form-textarea" id="in-matB" name="matB" rows={5} spellCheck={false} onChange={onChange} />
      </div>
    </>
  );
}

function NewtonSystemFields({ onChange, onKeyDown }: FieldProps) {
  return (
    <>
      <div className="matrix-help">
      ...
      <div className="form-group">
        ...
        <input className="form-input" id="in-x0" name="x0Str" type="text" spellCheck={false} onChange={onChange} onKeyDown={onKeyDown} />
      ...
      <div className="form-group">
        ...
        <input className="form-input" id="in-tol" name="tol" type="text" onChange={onChange} onKeyDown={onKeyDown} />
      </div>
    </>
  );
}

function LapDonSystemFields({ onChange, onKeyDown }: FieldProps) {
  return (
    <>
      <div className="matrix-help">
      ...
      <div className="form-row">
        <div className="form-group">
          <label className="form-label" htmlFor="in-q">Hệ số co <code>q</code> (0 &lt; q &lt; 1)</label>
          <input className="form-input" id="in-q" name="q" type="number" step="any" onChange={onChange} onKeyDown={onKeyDown} />
        </div>
        <div className="form-group">
          <label className="form-label" htmlFor="in-eps">Sai số <code>ε</code></label>
          <input className="form-input" id="in-eps" name="epsilon" type="text" onChange={onChange} onKeyDown={onKeyDown} />
